...
// import 'package:es-bank-app/components/failure_screen.dart';
...
//           .then((response) => _showMessage(context, 'Aviso', response.mensagem))
//           .catchError((error) {
//         _showMessage(context, 'Erro', error.message);
//       });
//     } else {
//       _showMessage(context, 'Erro', 'É necessário informar o E-mail');
//     }
//   }
//
