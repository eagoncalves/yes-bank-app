import 'package:yes_bank_app/enums/device_screen_type.dart';
import 'package:yes_bank_app/ui/responsive_widget.dart';
...
class ScreenTypeLayout extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ResponsiveWidget(builder: (context, sizingInformation) {
      ...
      return getDevice(smallMobile) ?? getDevice(mobile);
    });
  }
